...
namespace GPSLauncher.ViewModels
{
    public class MainViewModel :INotifyPropertyChanged
    {
        public MainViewModel()
        {
            ...
            Item1x2 = new IndividualIconViewModel { Caption = "VS 2012", ImageSource = "http://fc06.deviantart.net/fs70/i/2012/344/9/1/flurry_ios_visual_studio_2012_replacement_icon_by_flakshack-d5nnelp.png" };
        }
